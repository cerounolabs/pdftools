        ...
        if (posText > 0) {
            if (forTxt.equals("Docume")){
                ...
                while(auxTxt.compareToIgnoreCase("") != 0) {
                    ...
                    System.out.println("WEBINFTRA_DIR " + WEBINFTRA_DIR);

                    posText         = posicionPalabra(auxTxt, "Lugar:");
                    WEBINFTRA_EMP   = auxTxt.substring(posText + 7, posText + auxTxt.indexOf("\r\n"));
                    System.out.println("WEBINFTRA_EMP " + WEBINFTRA_EMP);
                    auxTxt          = auxTxt.substring(posText + 9 + auxTxt.indexOf("\n"));

                    System.out.println("auxTxt " + auxTxt);
                    WEBINFTRA_ING   = auxTxt.substring(3, 13);
                    System.out.println("WEBINFTRA_ING " + WEBINFTRA_ING);
                    auxTxt          = auxTxt.substring(14);
                    
                    WEBINFTRA_FRS   = auxTxt.substring(50, 60);
                    System.out.println("WEBINFTRA_FRP " + WEBINFTRA_FRS);
                    auxTxt          = auxTxt.substring(60);

                    WEBINFTRA_FRP   = auxTxt.substring(0);
                    System.out.println("WEBINFTRA_FRS " + WEBINFTRA_FRP);
